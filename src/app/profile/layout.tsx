...
export default function ProfileLayout({
  ...
  return (
    <>
      {/* <Header /> */}
      <div className="flex flex-1"> {/* Ensure layout takes full height */}
         <SidebarProvider defaultOpen={true} collapsible="icon">
             <Sidebar side="left" variant="sidebar" collapsible="icon" className="border-r flex flex-col h-full">
                 ...
                 <SidebarContent className="flex-grow"> {/* Allow content to grow */}
                     <SidebarMenu>
             ...
             <SidebarInset className="flex-grow"> {/* Ensure inset takes remaining space */}
